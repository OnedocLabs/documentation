...
<Note>
  ...
  For any inquiries, please contact our [**support team**](www.codemuse.app) or join the [**waiting list**](www.codemuse.app) !
</Note>
...
<Steps>
  <Step title="Sign-up and get your API Key">
    Create your Onedoc account and request your API Key
  </Step>
  <Step title="Create your template">
    Model your first template using your favorite progamming language 
  </Step>
...
</svg>}    href="https://mintlify.com/docs/development"
  >
