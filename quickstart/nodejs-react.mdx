---
title: "Node.js + React"
description: "Learn how to create your first document using the Onedoc Node.js + React SDK."
icon: react
---
...
Then create your document template on `components/pdf-template.js`.<br/>Your file must export a React component.
