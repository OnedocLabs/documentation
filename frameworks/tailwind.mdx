---
title: "Tailwind CSS"
description: "Learn how to create your first document using the Onedoc Node.js + TailwindCSS."
icon: t
---

<Warning>
  Onedoc is currently in publi beta mode.
</Warning>
...
Create a new `generate.tsx' file, import the React document template and generate a PDF using your `ONEDOC_API_KEY` and your main React component.
...
(async () => {
  ...
  const html = renderToString(<PDFTemplate name="Bruce Wayne" />)
