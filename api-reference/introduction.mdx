...
This step returns a list of signed bucket URLs to which you should upload your assets' content. You should include your base html file, stysheets, and all potential assets such as images, logos etc. <br/>
